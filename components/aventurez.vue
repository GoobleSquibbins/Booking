<template>
    <div class="daFont not-italic absolute w-[1208px] h-[469px] left-[80px] right-[80px] top-[1540px]">
        ...
        <p class="absolute w-[580px] h-[38px] left-0 top-[36px] font-[10+0] text-[16px] leading-[19px] text-[#484848]">
        ...
        <div class="cardHolderCase absolute grid grid-cols-6 gap-[16px] justify-start w-[1208px] h-[371px] top-[20.9%]">
            <div v-for="item in data" class="cards flex flex-col items-start justify-start rounded-[4px]">
                <div class="cardContent rounded-[4px]">
                    ...
                    <h1 class="absolute top-[264px] w-[188px] font-[700] text-[16px] leading-[19px] text-[#484848]">
                        {{ item.desc }}
                    </h1>
                    ...
                    <div class="rating absolute top-[96.23%] w-[30px]">
                        ...
                        <img src="/Star.png" class="absolute left-[22px] top-[3px] h-[8px] w-[8px]">
                    </div>
                </div>
            </div>
        </div>
