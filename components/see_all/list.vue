<template>
    <div class="h-[900px]">
        <div class="w-[300px]">
            <div class="border-[1px] border-black rounded-[20px] w-full p-[10px] flex flex-row items-center">
        ...
        <div
            ...
            <div class="w-full h-full">
                <button @mouseup="selCat('')" @click="filterDaData()" autoFocus
                    class="
            ...
            <div v-for=" item in filteredItems.products" class="w-full flex flex-col items-start">
                <NuxtLink :to="'/details/' + item.id" class="w-full h-full">
                    <img class="w-full h-[200px]
                                        rounded-[4px] object-cover mb-[8px]" :src="item.thumbnail" alt="">
                </NuxtLink>
