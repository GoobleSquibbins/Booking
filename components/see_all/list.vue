<template>
    <div class="relative">
        <div class="grid md:grid-cols-4 grid-cols-2 md:gap-[16px] gap-[10px] justify-start md:w-[1340px] w-full pb-[80px] md:pl-0 pl-[10px] md:pr-0 pr-[10px]">
        ...
        translate: ['100%', 0, 0],
                    ...
                    <SwiperSlide v-for="image in item.images" class="w-[323px] h-[200px]">
                        <NuxtLink :to="'/details/' + item.id" class="w-[323px] h-[200px]">
                            <img :src="image" alt="" class="w-[323px] h-[200px] object-cover duration-1000 rounded-[4px]">
                        </NuxtLink>
                    </SwiperSlide>
                </Swiper>
                ...
                <div class="row1 grid grid-cols-5 w-full">
                    ...
                    <NuxtLink :to="'/category/' + item.category" class="w-full h-full col-span-2 mt-[8px]">
                        <button
                            class="border-[1px] text-black border-black rounded-[2px] box-border w-full h-[30px] hover:border-[#FF5A5F] hover:text-[#FF5A5F] transition ease-in-out delay-[30ms]">
