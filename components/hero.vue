<template>
    <div class="heroo hero_bg w-[1366px] h-[750px] top-0 left-0 right-0 absolute bg-[#1d6187]">
            <img class="absolute object-cover w-[1366px] h-[750px] left-0 top-0 right-0" src="https://s3-alpha-sig.figma.com/img/95f0/5073/2310fe90b005326703715340fba77f9f?Expires=1685923200&Signature=DcdsIOYyxlcKlLKnl-RxK56ccnYriVsN7jNYNQsdc7Pw3AlAJ8aFcp0p0NV6ldHAwuwQor1Po6iZB9ByAFGKX5P-6TELUlLZ1n58Qbko6xPPhpdYlpKwYfMl~CsgEzU6JC0A~SJI6VtjYncpdxOOEHjbnhpEaR3rn8P3LFugu80z~4uBMQt5dm68tvQX1aqbcJAnPlD5KoQ7Xo62Hids3dCeBI-8sWvhV15AM7hTplgAPJ-8wF~2CD8dNcN1Q86UGG-0G2PcPD~FQOp~OjXGvo6Oi9gGZHTqqfpLiUbkbjBrMbBvLY-Iq2VH1Qll~a0BYD2axBsOEEw-bPmcjxmZrA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="">
            <form class="reserveCard w-[391px] h-[508px] left-[80px] top-[132px] absolute">
                <!-- Title -->
                <div class="absolute card w-[391px] h-[508px] left-0 top-0 bg-white rounded-[4px]">
                    <div
                        class="HugeText w-[343px] h-[114px] left-[24px] top-[32px] font-medium text-[32px] leading-[38px] text-[#484848] absolute">
