<template>
    <div class="heber w-[1208px] mt-[88px]">
        <h1 class=" w-[291px] h-[28px] left-0 top-0 font-[700] text-[24px] leading-[28px] text-[#484848]">
            Hébergements Airbnb Plus
        </h1>
        <p
            class="mt-[8px] mb-[24px] w-[546px] h-[19px] left-0 top-[36px] font-[300] text-[16px] leading-[19px] text-[#484848]">
            Une sélection de logements vérifiés selon des critères de qualité et de design
        </p>
        <div
            class="bigCard flex flex-row items-center justify-center w-[1206px] h-[310px] left-0 top-[79px] bg-[url(/Rectangle5.png)]">
            <div class="flex flex-col items-center justify-center">
                <svg class="logoo  fill-white top-[65.87px] left-[550.66px]" width="104.5px" height="112.27"
                ...
                <div class="secondaryCTA mt-[37.87px] w-[200px] h-[44px]">
                    <button
                        class="rectangle6  w-full h-full text-center bg-white rounded-[4px] flex flex-row items-center text-[#484848] hover:bg-[#FF5A5F] hover:text-white transition ease-in-out delay-[30ms]">
                        <div class="flex flex-row items-center justify-center w-full h-full">
                            <h1 class=" left-[24px] top-[16px] font-[700] text-[10px] leading-[12px] uppercase">
                                Découvrir des logements
                            </h1>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-3 h-5  right-[16px]">
