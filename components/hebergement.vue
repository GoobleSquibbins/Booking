<template>
    <div class="heber absolute w-[389px] left-[80px] right-[80px] top-[1063px]">
        <h1 class="absolute w-[291px] h-[28px] left-0 top-0 font-[700] text-[24px] leading-[28px] text-[#484848]">
            Hébergements Airbnb Plus
        </h1>
        <p class="absolute w-[546px] h-[19px] left-0 top-[36px] font-[300] text-[16px] leading-[19px] text-[#484848]">
            Une sélection de logements vérifiés selon des critères de qualité et de design
        </p>
        <div class="bigCard absolute w-[1206px] h-[310px] left-0 top-[79px] bg-[url(/Rectangle5.png)]">
            <svg class="logoo absolute fill-white top-[65.87px] left-[550.66px]" width="104.5px" height="112.27"
        ...
        <div class="loggo absolute w-[1206px] h-[310px] left-0 top-[79px] flex flex-col items-center">
            <div class="logo mt-[65.87px]">
        ...
        <div class="secondaryCTA absolute w-[200px] h-[44px] left-[503px] top-[295px]">
            <button
                class="rectangle6 absolute top-0 left-0 right-0 bottom-0 bg-white rounded-[4px] flex flex-row items-center text-[#484848] hover:bg-[#FF5A5F] hover:text-white transition ease-in-out delay-[30ms]">
